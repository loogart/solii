...
<body>
    ...
    <main>
        <img class="product-jumbotron" src="./img/jumbo-product-banner.jpg">
        <section class="content-area">
            <div class="container p-3 p-md-5">
                <h1 class="text-uppercase mb-md-5">Standard Out-Swing Casement</h1>
                <div class="row">
                    <div class="col-12 col-md-4 text-center product-img">
                        <img class="img-fluid p-4" src="./img/windows/inswing.jpg">
                        <div class="product-images">
                            <a href="./img/classic.jpg" class="d-none">View all Photos</a>
                        ...
                        <div class="tab-content pt-4 pb-5" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <ul class="list-unstyled download-links">
                                    <li><a href="./#!">Download Product Info <i class="far fa-arrow-to-bottom"></i></a></li>
                                    <li><a href="./#!">Download Installation Manual <i class="far fa-arrow-to-bottom"></i></a></li>
                                    <li><a href="./#!">Download No. 3 <i class="far fa-arrow-to-bottom"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
