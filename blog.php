                    ...
                    <div class="col-12 mx-auto">
                        ...
                        <div class="card-deck mb-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a class="card-title" href="./signs-you-need-to-upgrade-your-front-door.php">
                                        <h5>5 Signs You Need to Upgrade Your Front Door</h5>
                                    </a>
                                    <a class="card-text" href="./signs-you-need-to-upgrade-your-front-door.php">
                            ...
                            <div class="card">
                                <a href="./window-cleaning-tips.php"><img class="card-img-top" src="./img/blog-clean-window-1.jpg" alt="Clean Window Blog Post Image"></a>
                                <div class="card-body">
                                    <a class="card-title" href="./window-cleaning-tips.php">
                                        <h5>Need to Know Cleaning Tips for Your Windows</h5>
                                    </a>
                                    <a class="card-text" href="./window-cleaning-tips.php">
                        ...
                        <div class="card-deck mb-3">
                            ...
                            <div class="card">
                                <a href="./heritage-buildings-in-ottawa.php"><img class="card-img-top" src="./img/blog-heritage-1.png" alt="Heritage Building Canada"></a>
                                <div class="card-body">
                                    <a class="card-title" href="./heritage-buildings-in-ottawa.php">
                                        <h5>4 Heritage Buildings in Ottawa That Will make You Swoon</h5>
                                    </a>
                                    <a class="card-text" href="./heritage-buildings-in-ottawa.php">
                            ...
                            <div class="card">
                                <a href="./epic-front-doors.php"><img class="card-img-top" src="./img/blog-doors-1.png" alt="Card image cap" style="object-fit:cover;height:200px"></a>
                                <div class="card-body">
                                    <a class="card-title" href="./epic-front-doors.php">
                                        <h5>5 Epic Front Doors That Will Give You Major Home Envy</h5>
                                    </a>
                                    <a class="card-text" href="./epic-front-doors.php">
                            ...
                            <div class="card">
                                <a href="./selecting-custom-luxury-windows.php"><img class="card-img-top" src="./img/blog1.jpg" alt="Luxury home interior"></a>
                                <div class="card-body">
                                    <a class="card-title" href="./selecting-custom-luxury-windows.php">
                                        <h5>5 Things to Consider When Selecting Custom Luxury Windows</h5>
                                    </a>
                                    <a class="card-text" href="./selecting-custom-luxury-windows.php">
