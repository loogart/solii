...
<body>
    ...
    <main>
        <div class="overflow-hidden">
            <img class="product-jumbotron rellax" src="./img/gallery/hung_1.jpg">
        </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-4 text-center product-img">
                        ...
                        <div class="product-images">
                            <a href="./img/windows/hung.jpg" class="d-none">View all Photos</a>
                            <a href="./img/gallery/hung_1.jpg" class="d-none">Open popup 2</a>
                        </div>
                    </div>
                    <div class="col-12 col-md-8 product-info">
                        ...
                        <div class="tab-content pt-4 pb-5" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <h3 class="py-3">3/4″ and 1/4″ Sash</h3>
                                <ul>
                                ...
                                <ul>
                                    <li>Solid brass sash locks and lifts</li>
                                    <li>Adjustable interior sash stops</li>
                                    <li>Many finishes and options available</li>
                                </ul>
                                <h3 class="py-3">Screen</h3>
                                <ul>
                                    <li>Coppertone, black or white aluminium frame screen with fibreglass mesh</li>
                                ...
                                <h3 class="py-3">Two Systems Available</h3>
                                <ul>
                                    <li>Weight and chain with heavy duty pulleys, chains and traditional bronze weather-stripping</li>
                                    <li>All wood invisible balance (no plastic liners) with the latest weather-stripping technology</li>
                                </ul>
                                ...
                                <p>Results obtained for this product (CSA A440-98) as recognized by the Canadian Normalisation Association:</p>
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <ul class="list-unstyled download-links">
                                    <li><a href="https://gemstonecorporation.box.com/s/8y7jx4hd43v8yuzqm2dt9fivznn0kb0m" target="_blank">Product Brochure <i class="far fa-arrow-to-bottom"></i></a></li>
