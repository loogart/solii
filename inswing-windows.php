...
<head>
    ...
    <title>Solii | Inswing Windows</title>
</head>
                ...
                <div class="row">
                    <div class="col-12 col-md-4 text-center product-img">
                        ...
                        <div class="product-images">
                            <a href="./img/windows/inswing.jpg" class="d-none">View all Photos</a>
                        ...
                        <div class="tab-content pt-4 pb-5" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <ul class="list-unstyled download-links">
                                    <li><a href="https://gemstonecorporation.box.com/s/92z0hn5rj45zmtrnfbcspjo757wvdyc3" target="_blank">Product Brochure <i class="far fa-arrow-to-bottom"></i></a></li>
